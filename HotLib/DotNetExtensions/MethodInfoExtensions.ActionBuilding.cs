...
namespace HotLib.DotNetExtensions
{
    public static partial class MethodInfoExtensions
    {
        ...
        public static Action BuildAction(this MethodInfo method) =>
            BuildAction(method, BuilderSetupNoOp);
        ...
        public static Action<TInstance> BuildAction<TInstance>(this MethodInfo method) =>
            BuildAction<TInstance>(method, BuilderSetupNoOp);
        public static Action<TInstance> BuildAction<TInstance>(this MethodInfo method, Action<DelegateBuilder> builderSetup) =>
            BuildAction<Action<TInstance>>(method, builderSetup, typeof(TInstance));

        public static Action<TInstance, T> BuildAction<TInstance, T>(this MethodInfo method) =>
            BuildAction<TInstance, T>(method, BuilderSetupNoOp);
        public static Action<TInstance, T> BuildAction<TInstance, T>(this MethodInfo method, Action<DelegateBuilder> builderSetup) =>
            BuildAction<Action<TInstance, T>>(method, builderSetup, typeof(TInstance), typeof(T));

        public static Action<TInstance, T1, T2> BuildAction<TInstance, T1, T2>(this MethodInfo method) =>
            BuildAction<TInstance, T1, T2>(method, BuilderSetupNoOp);
        public static Action<TInstance, T1, T2> BuildAction<TInstance, T1, T2>(this MethodInfo method, Action<DelegateBuilder> builderSetup) =>
            BuildAction<Action<TInstance, T1, T2>>(method, builderSetup, typeof(TInstance), typeof(T1), typeof(T2));

        public static Action<TInstance, T1, T2, T3> BuildAction<TInstance, T1, T2, T3>(this MethodInfo method) =>
            BuildAction<TInstance, T1, T2, T3>(method, BuilderSetupNoOp);
        public static Action<TInstance, T1, T2, T3> BuildAction<TInstance, T1, T2, T3>(this MethodInfo method, Action<DelegateBuilder> builderSetup) =>
            BuildAction<Action<TInstance, T1, T2, T3>>(method, builderSetup, typeof(TInstance), typeof(T1), typeof(T2), typeof(T3));

        public static Action<TInstance, T1, T2, T3, T4> BuildAction<TInstance, T1, T2, T3, T4>(this MethodInfo method) =>
            BuildAction<TInstance, T1, T2, T3, T4>(method, BuilderSetupNoOp);
        public static Action<TInstance, T1, T2, T3, T4> BuildAction<TInstance, T1, T2, T3, T4>(this MethodInfo method, Action<DelegateBuilder> builderSetup) =>
            BuildAction<Action<TInstance, T1, T2, T3, T4>>(method, builderSetup, typeof(TInstance), typeof(T1), typeof(T2), typeof(T3), typeof(T4));

        public static Action<TInstance, T1, T2, T3, T4, T5> BuildAction<TInstance, T1, T2, T3, T4, T5>(this MethodInfo method) =>
            BuildAction<TInstance, T1, T2, T3, T4, T5>(method, BuilderSetupNoOp);
        public static Action<TInstance, T1, T2, T3, T4, T5> BuildAction<TInstance, T1, T2, T3, T4, T5>(this MethodInfo method, Action<DelegateBuilder> builderSetup) =>
            BuildAction<Action<TInstance, T1, T2, T3, T4, T5>>(method, builderSetup, typeof(TInstance), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5));

        private static TDelegate BuildAction<TDelegate>(MethodInfo method, Action<DelegateBuilder> builderSetup, Type instanceType, params Type[] parameterTypes)
        ...
        public static Action BuildActionStatic(this MethodInfo method) =>
            BuildActionStatic(method, BuilderSetupNoOp);
        public static Action BuildActionStatic(this MethodInfo method, Action<DelegateBuilder> builderSetup) =>
            BuildActionStatic<Action>(method, builderSetup, Type.EmptyTypes);
